...
<cfswitch expression="#request.ebx.act#">
	...
	<cfcase value="person">
		<cfparam name="attributes.name" default="John Doe">
		<cfparam name="attributes.dob"  default="1970-01-01">
		<cfoutput>#attributes.name# - #attributes.dob#</cfoutput>
	</cfcase>
	...
	<cfdefaultcase>
		...
		<cfset request.ebx.do(action="person", name="Deepak", dob="1977-10-13")>
	</cfdefaultcase>
</cfswitch>