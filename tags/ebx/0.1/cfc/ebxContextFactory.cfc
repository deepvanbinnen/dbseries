...
<cfcomponent hint="I am responsable for creating contexts">
	...
	<cffunction name="init" returntype="ebxContextFactory" hint="initialise factory">
		<cfargument name="ParserInterface" required="true" type="ebxParserInterface" hint="instance of parsercontroller">
