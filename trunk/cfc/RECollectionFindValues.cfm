...
<cffunction name="reCollectionFindValues" output="false" returntype="array" hint="recursively regex-search collection for matching values">
	...
	<cfargument name="path"       type="string"  required="false" hint="matched item's path" default="">
	...
	<cfset var it = createObject("component", "DBIterator.DBIterator").init(arguments.collection)>
