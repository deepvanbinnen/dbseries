<cfcomponent extends="cfc.pf">
	...
	<cffunction name="iterator">
		...
		<cfset StructInsert(variables.iterators, variables.numiterators, createObject("component", "cfc.db.Iterator").init(arguments.iterable), true)>
