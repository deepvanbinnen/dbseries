...
if(!DBScriptHandler){
	...
	DBScript.include("media/js/dollar_v2.js");
	DBScript.include("media/js/events_v2.js");
	DBScript.include("media/js/classes_v2.js");
	DBScript.include("media/js/DOMHelper_v2.js");
	DBScript.include("media/js/string.js");
	DBScript.include("media/js/tables.js");
	DBScript.include("media/js/xhr_v2.js");
}
