<cfcomponent hint="I represent a context">
	...
	<cffunction name="init" returntype="ebxAbstractContext" hint="initialise context from arguments">
		<cfargument name="parser"     type="ebxParser" required="true"  hint="the parser(-singleton) that requests the context">
		...
		<cfargument name="template"   type="string"    required="false" default=""              hint="full mapping path to include template for the context">
			...
			<cfset setAppPath(arguments.parser.getEbx().getAppPath())>
		<cfreturn this>
	</cffunction>
